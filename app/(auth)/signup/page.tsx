    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: 'var(--bg-canvas)' }}>
      ...
      <div style={{ width: '100%', maxWidth: '420px' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ color: 'var(--text-heading)', fontSize: '24px', fontWeight: 700, margin: '0 0 8px' }}>Create an account</h1>
          <p style={{ color: 'var(--text-secondary)', fontSize: '14px', margin: 0 }}>Join to save your tracker data</p>
        </div>
        <div style={cardStyle}>
