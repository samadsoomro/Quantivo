        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="bg-[#c0c1ff] text-[var(--bg-canvas)] px-6 py-2.5 rounded-full font-medium flex items-center gap-2 hover:brightness-110 hover:shadow-[0_0_20px_rgba(var(--color-primary-rgb),0.3)] transition-all"
            >
          ...
          <div className="glass-modal w-full max-w-md p-6 flex flex-col gap-6 animate-in fade-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-full text-sm font-medium transition-all ${addModal.type === 'income' ? 'bg-[#c0c1ff] text-[var(--bg-canvas)] hover:shadow-[0_0_15px_rgba(var(--color-primary-rgb),0.3)]' : 'bg-[#fa8c00] text-[var(--bg-canvas)] hover:shadow-[0_0_15px_rgba(250,140,0,0.3)]'} disabled:opacity-50 disabled:pointer-events-none`}
              >
