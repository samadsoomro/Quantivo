  ...
  return (
    <div className="max-w-[1440px] mx-auto pb-12 space-y-6">
      <div className="flex justify-between items-end mb-10">
        <div>
          <h1 className="font-headline-xl text-3xl font-bold text-[var(--color-primary)] mb-2">Site Editor</h1>
          <p className="font-body-md text-sm text-[var(--text-secondary)]">Manage landing page copy and configuration.</p>
        </div>
      </div>

      <div className="bg-[var(--bg-card)] backdrop-blur-md border border-[var(--border)] rounded-2xl p-8 max-w-2xl">
        <h2 className="text-xl font-bold text-[var(--text-primary)] mb-6">Hero Section</h2>
